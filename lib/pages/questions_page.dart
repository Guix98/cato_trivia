                    ...
                    child: ListView(
                      ...
                      [
                        Obx(
                          () {
                            return CircleAvatar(
                              backgroundColor: _gameController.questionResult.value==true?colors.green:_gameController.questionResult.value==false?colors.red:colors.pinkSalmon,
                              radius: 30,
                              child:
                        ...
                        SizedBox(height: 30,),
                        Text("PREGUNTA ${i+1} DE ${_quizzController.categoryQuestionList.length} ",
                          style: GoogleFonts.rubik(
                              fontWeight: FontWeight.w600, fontSize: 18,color: colors.grey2),),
                        SizedBox(height: 10,),
                      ...
                      child: Obx(
                        () {
                          return AnimatedOpacity(
                            ...
                            opacity: _gameController.questionResult.value!=null?1:0,
                            child: MaterialButton(
                              ...
                              child: Text(_quizzController.categoryQuestionList.length==i+1?"Terminar":"Siguiente",
                                  style: GoogleFonts.rubik(
      ...
      child: Column(
        ...
        children: [
          ...
          CircleAvatar(
            ...
            radius: 100,
            child:
            Text("${_gameController.score}/${_quizzController.categoryQuestionList.length*10}",
              style: GoogleFonts.rubik(
                  fontWeight: FontWeight.w600, fontSize: 40,color: colors.royalBlue),),
          ),
          SizedBox(height: 10,),
          Text("Correctas: ${_gameController.rightAnswers}",
            textAlign: TextAlign.center,
            style: GoogleFonts.rubik(
                fontWeight: FontWeight.w600, fontSize: 14,color: colors.grey2),),
          SizedBox(height: 5,),
          Text("Incorrectas: ${_gameController.wrongAnswers}",
            textAlign: TextAlign.center,
            style: GoogleFonts.rubik(
                fontWeight: FontWeight.w600, fontSize: 14,color: colors.grey2),),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            color: option=="FALSO"?colors.red.withOpacity(1):colors.green.withOpacity(1),
  ...
  Widget optionCard(String option,int number){
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        padding: EdgeInsets.all(20),
        decoration: BoxDecoration(
            color: _gameController.questionResult.value==false&&widget.question.respuesta!=option&&_selected==number?colors.red:_gameController.questionResult.value!=null&&widget.question.respuesta==option?colors.green:_selected==number?colors.hawkesBlue:colors.white,
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: colors.hawkesBlue)
        ),
        child: Text(option,
